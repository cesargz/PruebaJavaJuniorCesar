	...
	<div id="contenido">
        ...
        <%
            ...
            if(rs!=null)
            {
                ...
                {
        %>
        <p align="center"><strong>Escoge un Album para ver sus Secciones</strong></p>
              <form id="form1" name="form1" method="post" action="../GestionarSeccion.do" onsubmit="return validarRegistrarSeccion(this)">
              <table width="296" border="0" align="center">
                  ...
                  <tr>
                    <td colspan="2">
                      <div align="center">
                        <input type="hidden" name="bandera" id="bandera" value="MostrarSeccionesAlbum" />
                        <input type="submit" name="btnMostrarSeccionesAlbum" id="btnMostrarSeccionesAlbum" value="Ver Secciones" />
                      </div>
                    </td>
                  </tr>
                </table>
